    ...
    <main className="min-h-screen bg-[var(--bg-page)]">
      <section className="page-section-white">
        <div className="container-page max-w-4xl">
          <span className="inline-block px-3 py-1 rounded-full bg-[#B30027] text-white text-sm font-bold uppercase tracking-wide mb-4">New Program</span>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/courses" className="inline-flex items-center gap-2 border-2 border-[#B30027] text-[#B30027] hover:bg-[#B30027] hover:text-white px-5 py-2.5 rounded-lg font-semibold transition-colors">
              View all courses
            </Link>
          </div>
        </div>
