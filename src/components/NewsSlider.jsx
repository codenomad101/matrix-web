      ...
      <div className="container-content">
        <div className="flex items-center gap-3 sm:gap-4 py-3 px-4 sm:px-6">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            <svg className="w-4 h-4 sm:w-5 sm:h-5 text-[#B30027] animate-pulse flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
            ...
            >
              {newsItems.map((item, idx) => (
                ...
                >
                  <Link
                    href={item.link}
                    className="flex items-center gap-2 group hover:text-[#ff4d6d] transition-colors duration-300 w-full"
                  >
