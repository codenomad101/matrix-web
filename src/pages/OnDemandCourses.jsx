    ...
    <div className="container-page py-6">
      ...
      <div className="text-center mb-6" data-section data-index={0}>
        <div className="inline-block mb-4">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[var(--brand-red)] mb-3">
            On Demand Courses: On-Demand
          </h1>
        </div>
        <p className="text-[var(--brand-red)] text-lg max-w-3xl mx-auto">
        ...
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <div className="card rounded-2xl overflow-hidden h-full">
            ...
            <div className="p-6 bg-gradient-to-br from-green-50 to-green-100">
              <h3 className="text-xl font-bold text-[var(--brand-red)] mb-2">MATRIX App</h3>
              <p className="text-[var(--brand-red)] text-sm">Access recorded lectures, notes, and question solutions anytime</p>
            </div>
          </div>
        </div>
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <div className="card rounded-2xl overflow-hidden h-full">
            ...
            <div className="p-6 bg-gradient-to-br from-brand/20 to-brand-dark/10">
              <h3 className="text-xl font-bold text-[var(--brand-red)] mb-2">Our Infrastructure</h3>
              <p className="text-[var(--brand-red)] text-sm">State-of-the-art learning facilities</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6" data-section data-index={2}>
        <div className={`card p-8 md:p-10 mb-5 transition-all duration-1000 ease-out ${
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-[var(--brand-red)] mb-6 text-center">
              Impulse Batch by MATRIX: Revolutionizing 11th and 12th Std Education
            </h2>
            <p className="text-[var(--brand-red)] text-lg leading-relaxed mb-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-5">
              {stats.map((stat, idx) => (
                ...
                >
                  ...
                  <div className="text-sm font-semibold text-[var(--brand-red)] mb-1">{stat.year}</div>
                  <div className="text-xs text-[var(--brand-red)]">{stat.label}</div>
                </div>
              ))}
            </div>
              ...
              {features.map((feature, idx) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <p className="text-[var(--brand-red)] leading-relaxed pt-1">{feature}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className={`transition-all duration-1000 ease-out ${
          ...
          <div className="rounded-2xl bg-gradient-to-br from-brand/20 via-brand-dark/10 to-brand/20 p-8 md:p-10 border border-brand/30 shadow-xl">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-[var(--brand-red)] mb-5 text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {appContent.map((item, idx) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-[var(--brand-red)] mb-2 text-center">{item.title}</h3>
                    <p className="text-[var(--brand-red)] text-center text-sm">{item.description}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <div className="rounded-2xl bg-gradient-to-br from-brand/20 via-brand-dark/10 to-brand/20 p-8 md:p-10 border border-brand/30 shadow-xl">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-2xl md:text-3xl font-bold text-[var(--brand-red)] mb-4">Ready to Get Started?</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/enquiry" className="inline-flex justify-center items-center gap-2 rounded-lg bg-[var(--brand-red)] text-white hover:bg-[var(--brand-red-hover)] transition-colors duration-300 px-5 py-2.5 font-medium shadow-soft">
              Enquire Now
            </a>
