  ...
  return (
    <div className="container-page py-10">
      <div className="text-center mb-10">
        <h1 className="text-3xl sm:text-4xl font-bold text-slate-700 mb-3">Felicitation Ceremonies</h1>
      ...
      <div className="space-y-12">
        ...
        <div>
          <h2 className="text-3xl font-bold text-slate-700 mb-8">Felicitation Ceremony 2024</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold text-slate-700 mb-8">Achievement Awards & Recognition</h2>
          <div className="flex justify-center">
            <div className="rounded-2xl overflow-hidden shadow-lg max-w-4xl w-full">
              <img 
